...
class Config:
    ...
    # Free Stock Video APIs (RECOMMENDED - Zero cost!)
    PEXELS_API_KEY = os.getenv('PEXELS_API_KEY')
    PIXABAY_API_KEY = os.getenv('PIXABAY_API_KEY')
    
    # Video Generation Source: 'pexels' (free), 'pixabay' (free), or 'runway' (expensive)
    ...
    BACKGROUND_MUSIC_DIR = Path(os.getenv('BACKGROUND_MUSIC_DIR', './music'))
    DEFAULT_BGM_VOLUME = float(os.getenv('BGM_VOLUME', '0.3'))  # 30% volume for background music
